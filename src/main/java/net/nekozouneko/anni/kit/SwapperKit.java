...
import net.nekozouneko.anni.item.Swapper;
...
public class SwapperKit extends InternalKit{
    
    SwapperKit() {
        super("swapper", "kit.swapper.name", "kit.swapper.description", "SWP", Material.MUSIC_DISC_CAT);
    }
